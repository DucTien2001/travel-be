...
hotelCommentRouter.route("/get-all-hotel-comments").post(HotelCommentController.getAllHotelComments);
hotelCommentRouter.route("/get-hotel-comments-need-delete").get(HotelCommentController.getHotelCommentsNeedDelete);
...
hotelCommentRouter.route("/request-delete/:id").put(HotelCommentController.requestDeleteHotelComment);
hotelCommentRouter.route("/decline-delete/:id").put(HotelCommentController.declineDeleteHotelComment);
